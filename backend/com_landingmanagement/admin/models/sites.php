 ...
 * @author Joomline
 */
class LandingmanagementModelSites extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from( '#__landingmanagement_sites as t1' );
	...
	public function getAuthors()
	{
		...
		$query->join( 'INNER', '#__landingmanagement_sites AS c ON c.created_by = u.id' );
