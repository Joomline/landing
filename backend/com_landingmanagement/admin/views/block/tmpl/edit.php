<?php
/** @var $this LandingmanagementViewBlock */
...
<script type="text/javascript">
	Joomla.submitbutton = function (task) {
		if (task == 'block.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
	...
	<div class="form-horizontal">
		<div class="row-fluid">
			<div class="span9">
                ...
                <div class="control-group">
                    <div class="control-label"><?php echo $this->form->getLabel( 'menu_title' ); ?></div>
                    <div class="controls"><?php echo $this->form->getInput( 'menu_title' ); ?></div>
                </div>
