 ...
 * @author Joomline
 */
class LandingmanagementViewPages extends JViewLegacy
{
	/**
	 * @var $items stdClass[]
	 */
	...
	public function display( $tpl = null )
	{
		...
		if ( $this->getLayout() !== 'modal' ) {
			$this->addToolbar();
			landingmanagementHelper::addSubmenu( 'pages' );
	...
	protected function addToolbar()
	{
		...
		$canDo = landingmanagementHelper::getActions( 'page' );
		...
		if ( $canDo->get( 'core.edit.state' ) ) {
			...
			if ( $canDo->get( 'core.delete' ) ) {
				JToolBarHelper::deleteList( 'DELETE_QUERY_STRING', 'pages.delete', 'JTOOLBAR_DELETE' );
				JToolBarHelper::divider();
			}
