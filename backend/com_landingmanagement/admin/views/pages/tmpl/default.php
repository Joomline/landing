<?php
/** @var $this LandingmanagementViewPages */
...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_landingmanagement&task=pages.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_( 'index.php?option=com_landingmanagement&view=pages' ); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="articleList">
				...
				<?php foreach ( $this->items as $i => $item ) :
					...
					$canEdit = $user->authorise( 'core.edit', '#__landingmanagement_pages.' . $item->id );
					$canCheckin = $user->authorise( 'core.manage', 'com_landingmanagement' ) || $item->checked_out == $userId || $item->checked_out == 0;
					$canEditOwn = $user->authorise( 'core.edit.own', '#__landingmanagement_pages.' . $item->id ) && $item->created_by == $userId;
					$canChange = $user->authorise( 'core.edit.state', '#__landingmanagement_pages.' . $item->id ) && $canCheckin;
					?>
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								<?php if ( $canEdit || $canEditOwn ) : ?>
									<a href="<?php echo JRoute::_( 'index.php?option=com_landingmanagement&task=page.edit&id=' . $item->id ); ?>" title="<?php echo JText::_( 'JACTION_EDIT' ); ?>">
							...
							<div class="pull-left">
								...
								if ( $item->state ) :
									JHtml::_( 'dropdown.unpublish', 'cb' . $i, 'Pages.' );
								else :
									JHtml::_( 'dropdown.publish', 'cb' . $i, 'Pages.' );
								endif;
