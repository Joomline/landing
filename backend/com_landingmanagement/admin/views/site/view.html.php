 ...
 * @author Joomline
 */
class LandingmanagementViewSite extends JViewLegacy
{
	...
	public function display( $tpl = null )
	{
		...
		$this->canDo = landingmanagementHelper::getActions( 'site' );
		$this->_setToolBar();
		parent::display( $tpl );
	}
	...
	protected function _setToolBar()
	{
		...
		$canDo = landingmanagementHelper::getActions( 'site', $this->item->id );
