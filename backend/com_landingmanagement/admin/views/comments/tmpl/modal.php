...
?>
<form action="<?php echo JRoute::_( 'index.php?option=com_landingmanagement&view=comments&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1' ); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
